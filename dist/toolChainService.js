...
var ToolChainService = /** @class */ (function () {
    function ToolChainService(debug) {
        var _this = this;
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        if (!this._customPutVerification[data.key]) return [3 /*break*/, 2];
                                        return [4 /*yield*/, this.dbRead(data.key)];
                                    case 1:
                                        oldValue = _a.sent();
                                        verified = !this._customPutVerification[data.key](oldValue || undefined, data)
    ...
    ToolChainService.prototype.dataPutHandler = function (msg) {
...
exports.default = ToolChainService;
